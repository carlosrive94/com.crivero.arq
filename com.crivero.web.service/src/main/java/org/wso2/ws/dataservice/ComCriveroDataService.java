 ...
 * 2016-11-03T10:32:57.848+01:00
 * Generated source version: 2.7.8
 * 
 */
@WebServiceClient(name = "com.crivero.data.service", 
                  wsdlLocation = "http://localhost:9763/services/com.crivero.data.service?wsdl",
...
public class ComCriveroDataService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9763/services/com.crivero.data.service?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ComCriveroDataService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:9763/services/com.crivero.data.service?wsdl");
        }
        WSDL_LOCATION = url;
    }
