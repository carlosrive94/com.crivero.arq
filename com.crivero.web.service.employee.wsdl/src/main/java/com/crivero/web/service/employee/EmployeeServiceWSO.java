 ...
 * 2016-10-26T13:22:29.715+02:00
 * Generated source version: 2.7.8
 * 
 */
@WebServiceClient(name = "employeeServiceWSO", 
                  wsdlLocation = "http://7.116.104.141:9764/services/employeeServiceWSO?wsdl",
                  targetNamespace = "http://employee.service.web.crivero.com") 
public class EmployeeServiceWSO extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://employee.service.web.crivero.com", "employeeServiceWSO");
    public final static QName EmployeeServiceWSOHttpSoap12Endpoint = new QName("http://employee.service.web.crivero.com", "employeeServiceWSOHttpSoap12Endpoint");
    public final static QName EmployeeServiceWSOHttpSoap11Endpoint = new QName("http://employee.service.web.crivero.com", "employeeServiceWSOHttpSoap11Endpoint");
    public final static QName EmployeeServiceWSOHttpsSoap12Endpoint = new QName("http://employee.service.web.crivero.com", "employeeServiceWSOHttpsSoap12Endpoint");
    public final static QName EmployeeServiceWSOHttpsEndpoint = new QName("http://employee.service.web.crivero.com", "employeeServiceWSOHttpsEndpoint");
    public final static QName EmployeeServiceWSOHttpEndpoint = new QName("http://employee.service.web.crivero.com", "employeeServiceWSOHttpEndpoint");
    public final static QName EmployeeServiceWSOHttpsSoap11Endpoint = new QName("http://employee.service.web.crivero.com", "employeeServiceWSOHttpsSoap11Endpoint");
    static {
        URL url = null;
        try {
            url = new URL("http://7.116.104.141:9764/services/employeeServiceWSO?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EmployeeServiceWSO.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://7.116.104.141:9764/services/employeeServiceWSO?wsdl");
        }
        WSDL_LOCATION = url;
    }
